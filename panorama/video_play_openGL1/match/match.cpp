                            ...
                            int &panorama_width, int &panorama_height)
{
    ...
    int w = table_width / WIDTH_INTERVAL;
    int h = table_height / HEIGHT_INTERVAL;
    //设置为16的倍数，vpu h264编码要求图像尺寸必须为16的倍数
    panorama_width = w & 0xfffffff0;
    panorama_height = h & 0xfffffff0;

    printf("readWidhtHeight panorama_width: %d, panorama_height: %d\n",
